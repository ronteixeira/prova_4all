...
public class FinishSell {
	...
	public void subProduct(String productName, int clickTimes) {
		for (int i = 0; i < clickTimes; i++) {
			WebElement product = driver.findElement(By.xpath("//*[contains(text(), '"+productName+"')]//../div[1]/div[1]"));
			product.click();
		}
	}
	...
	public void quantityItems(String productName) {
		WebElement items = driver.findElement(By.xpath("//*[contains(text(), '\"+productName+\"')]//../div[1]/p"));
